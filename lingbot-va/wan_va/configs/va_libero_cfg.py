...
# Local model path on this box (/data_sde was a foreign mount, now unmounted; the model
# was remapped under /workspace/vla/models like the robotwin/descendant configs).
va_libero_cfg.wan22_pretrained_model_name_or_path = "/workspace/vla/models/lingbot-va-posttrain-libero-long"
